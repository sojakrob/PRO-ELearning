...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [ELearning], FILENAME = N'$(DefaultDataPath)ELearning.mdf')
    LOG ON (NAME = [ELearning_log], FILENAME = N'$(DefaultLogPath)ELearning_log.ldf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
