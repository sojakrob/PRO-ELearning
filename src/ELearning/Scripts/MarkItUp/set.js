...
//		{ name: 'Stroke', key: 'S', openWith: '[S:', closeWith: ']' },
		{separator: '---------------' },
        { name: 'Paragraph', key: 'P', openWith: '|P ', closeWith: '\n', placeHolder: 'Text' },
        { name: 'Center Aligned Paragraph', key: 'C', openWith: '|PC ', closeWith: '\n', placeHolder: 'Text' },
        { name: 'Right Aligned Paragraph', key: 'R', openWith: '|PR ', closeWith: '\n', placeHolder: 'Text' },
        { separator: '---------------' },
...
//		{ name: 'Link', key: "L", openWith: "[[![Link]!] ", closeWith: ']', placeHolder: 'Your text to link here...' },
		{ name: 'Url', openWith: "[URL: click here | ", closeWith: ' ]', placeHolder: 'your link' },
		{ separator: '---------------' },
		{ name: 'Cite', key: 'C', openWith: '|CITE ', closeWith: '\n', placeHolder: 'Text' },
